...
<script>
	$(document).ready(function(){
		...
		$("#good").on("click", function(){
			...
			$.ajax({
		        type: "POST", 
		        url: "${pageContext.request.contextPath}/movie/goodCount", 
		        data: allData,
		...
		$("#bad").on("click", function(){
			...
			$.ajax({
		        type: "POST", 
		        url: "${pageContext.request.contextPath}/movie/badCount", 
		        data: allData,
		        success: //호출이 성공하면 호출되는 함수를 정의한다.
...
<div class="container">
	...
	<div class="align-right">
		...
		<input type="button" class="btn" onclick="location.href='${pageContext.request.contextPath}/movie/movie-delete/${board.no }/${board.item_no }?tag=${board.tag.replace('#', '') }'" value="삭제하기">
		</c:if>
