...
<head>
	...
	<script src="http://malsup.github.com/jquery.form.js"></script> 
   	<script type="text/javascript" src="<c:url value="/smarteditors/js/service/HuskyEZCreator.js" />" charset="utf-8"></script>
   	<script type="text/javascript" src="<c:url value="/js/bootstrap.min.js"/> "></script>
	<script type="text/javascript" src="<c:url value="/smarteditors/photo_uploader/popup/jindo.min.js" />" charset="utf-8"></script>
	<script type="text/javascript" src="<c:url value="/smarteditors/photo_uploader/popup/jindo.fileuploader.js" />" charset="utf-8"></script>
	<script type="text/javascript" src="<c:url value="/smarteditors/photo_uploader/popup/attach_photo.js" />" charset="utf-8"></script>
	<style type="text/css">
	...
	/* Contents */
	.blind{
		visibility:hidden;position:absolute;line-height:0
	}
	#pop_wrap{
		width:383px
	}
	#pop_header{
		height:26px;padding:14px 0 0 20px;border-bottom:1px solid #ededeb;background:#f4f4f3
	}
	.pop_container{
		padding:11px 20px 0
	}
	#pop_footer{
		margin:21px 20px 0;padding:10px 0 16px;border-top:1px solid #e5e5e5;text-align:center
	}
	h1{
		color:#333;
		font-size:14px;
	...
	( function($) {
	    $(document).ready(function(){
	    	$("#submit1").on("click", function(){
	    		var form = $("#editor_upimage")[0];
		   		var formData = new FormData(form);
		   	       	 $.ajax({
		   	       	    url: '${pageContext.request.contextPath}/file_uploader',
		   	       	    processData: false,
		        		contentType: false,
		   	       	    data: formData,
		   	       	    type: 'POST',
...
<body>
	<div id="pop_wrap">
		...
		<div id="pop_container2" class="pop_container2">
	    	...
	    	<!-- content -->
			<form id="editor_upimage" name="editor_upimage" action="${pageContext.request.contextPath}/file_uploader" method="post" enctype="multipart/form-data">
	        <div id="pop_content2">
...
<!-- 		            <a href="javascript:fn_imageUp();"><img src="/review_re/smarteditor/img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a> -->
	    ...
	    <div id="pop_container" class="pop_container" style="display:none;">
			...
			<form id="editor_upimage5" name="editor_upimage5" action="#" method="post" enctype="multipart/form-data">
	        <div id="pop_content2">
				<input type="file" class="upload filestyle" id="uploadInputBox" name="Filedata" data-icon="false">
	            <p class="dsc" id="info"><strong>10MB</strong>이하의 이미지 파일만 등록할 수 있습니다.<br>(JPG, GIF, PNG, BMP)</p>
	        </div>
			</form>
