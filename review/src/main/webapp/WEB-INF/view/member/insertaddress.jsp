...
<label for = "sample6_address2">상세주소 : </label><input type="text" id="sample6_address2" placeholder="상세주소" name = "address2"><br>
<button class="btn btn-primary modify" type = "submit">입력</button>
</form>
</div>
